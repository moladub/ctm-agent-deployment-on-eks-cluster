...
sudo docker build -t <docker-image-tag> --build-arg AAPI_END_POINT=https://<endpoint>:8443/automation-api --build-arg AAPI_USER=user --build-arg AAPI_PASS=password --build-arg AGENT_IMAGE_NAME=Agent_20.100+OneCM.Linux  . 
